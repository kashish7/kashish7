/* global jQuery */
/* global wp */
function conceptly_media_upload(button_class) {
    'use strict';
 ...
 *** Generate unique id ***
 *********************************************/
function conceptly_customizer_repeater_uniqid(prefix, more_entropy) {
    'use strict';
 ...
 *** General Repeater ***
 *********************************************/
function conceptly_customizer_repeater_refresh_social_icons(th) {
    'use strict';
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + conceptly_customizer_repeater_uniqid();
    ...
    conceptly_customizer_repeater_refresh_general_control_values();
}


function conceptly_customizer_repeater_refresh_general_control_values() {
    'use strict';
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (!id) {
                id = 'social-repeater-' + conceptly_customizer_repeater_uniqid();
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || slide_align !== '' || color !== '') {
                values.push({
                    ...
                    'color': color,
                    'color2': color2,
                    'text': conceptlyescapeHtml(text),
                    'link': link,
                    'text2': conceptlyescapeHtml(text2),
                    'link2': link2,
                    'image_url': (choice === 'customizer_repeater_none' ? '' : image_url),
                    'choice': choice,
                    'title': conceptlyescapeHtml(title),
                    'subtitle': conceptlyescapeHtml(subtitle),
					'slide_align': conceptlyescapeHtml(slide_align),
                    'social_repeater': conceptlyescapeHtml(social_repeater),
                    'id': id,
                    'shortcode': conceptlyescapeHtml(shortcode)
                });
            }
...
jQuery(document).ready(function () {
    'use strict';
    var conceptly_theme_controls = jQuery('#customize-theme-controls');
    conceptly_theme_controls.on('click', '.customizer-repeater-customize-control-title', function () {
    ...
    conceptly_theme_controls.on('change', '.icp',function(){
        conceptly_customizer_repeater_refresh_general_control_values();
        return false;
    });
	
	conceptly_theme_controls.on('change','.customizer-repeater-slide-align', function(){
		conceptly_customizer_repeater_refresh_general_control_values();
        return false;
		
	});
	
    conceptly_theme_controls.on('change', '.customizer-repeater-image-choice', function () {
    ...
    conceptly_media_upload('.customizer-repeater-custom-media-button');
     ...
     *
     */
    conceptly_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        var split_add_more_button=jQuery(this).text();
        var split_add_more_button_split=split_add_more_button.substr(4, 12);
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + conceptly_customizer_repeater_uniqid();
		
		if(split_add_more_button_split=="Add New Slid")
        {
        if(jQuery('#exist_conceptly_Slider').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_conceptly_Slider').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_conceptly_Slider').val())+1;
         jQuery('#exist_conceptly_Slider').val(new_service_add_val);  
        }
        }
		
		 if(split_add_more_button_split=="Add New Serv")
        {
        if(jQuery('#exist_conceptly_Service').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_conceptly_Service').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_conceptly_Service').val())+1;
         jQuery('#exist_conceptly_Service').val(new_service_add_val);  
        }
        }
         if(split_add_more_button_split=="Add New Feat")
        {
        if(jQuery('#exist_conceptly_Feature').val()>=6)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_conceptly_Feature').val()<6)
        {
         var new_service_add_val=parseInt(jQuery('#exist_conceptly_Feature').val())+1;
         jQuery('#exist_conceptly_Feature').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Spon")
        {
        if(jQuery('#exist_conceptly_Sponsor').val()>=4)
        {
        jQuery(".customizer_sponsors_upgrade_section").show();
        return false;   
        }
         if(jQuery('#exist_conceptly_Sponsor').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_conceptly_Sponsor').val())+1;
         jQuery('#exist_conceptly_Sponsor').val(new_service_add_val);  
        }
        }
    ...
    conceptly_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_conceptly_Slider').val(parseInt(jQuery('#exist_conceptly_Slider').val())-1);  
                }
				if(split_delete_button_split=="Delete Servi")
                {
                jQuery('#exist_conceptly_Service').val(parseInt(jQuery('#exist_conceptly_Service').val())-1);  
                }
				if(split_delete_button_split=="Delete Featu")
                {
                jQuery('#exist_conceptly_Feature').val(parseInt(jQuery('#exist_conceptly_Feature').val())-1); 
                }
				if(split_delete_button_split=="Delete Spons")
                {
                jQuery('#exist_conceptly_Sponsor').val(parseInt(jQuery('#exist_conceptly_Sponsor').val())-1); 
                }
    ...
    conceptly_theme_controls.on('keyup', '.customizer-repeater-title-control', function () {
        conceptly_customizer_repeater_refresh_general_control_values();
    });
    ...
    conceptly_theme_controls.on('keyup', '.customizer-repeater-subtitle-control', function () {
        conceptly_customizer_repeater_refresh_general_control_values();
    });

    conceptly_theme_controls.on('keyup', '.customizer-repeater-shortcode-control', function () {
        conceptly_customizer_repeater_refresh_general_control_values();
    });

    conceptly_theme_controls.on('keyup', '.customizer-repeater-text-control', function () {
        conceptly_customizer_repeater_refresh_general_control_values();
    });

    conceptly_theme_controls.on('keyup', '.customizer-repeater-link-control', function () {
        conceptly_customizer_repeater_refresh_general_control_values();
    });

    conceptly_theme_controls.on('keyup', '.customizer-repeater-text2-control', function () {
        conceptly_customizer_repeater_refresh_general_control_values();
    });

    conceptly_theme_controls.on('keyup', '.customizer-repeater-link2-control', function () {
        conceptly_customizer_repeater_refresh_general_control_values();
    });
    ...
    /*----------------- Socials Repeater ---------------------*/
    conceptly_theme_controls.on('click', '.social-repeater-add-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-social-repeater-' + conceptly_customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
    ...
    conceptly_theme_controls.on('click', '.social-repeater-remove-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var repeater = jQuery(this).parent().parent();
        th.remove();
        conceptly_customizer_repeater_refresh_social_icons(repeater);
        return false;
    });

    conceptly_theme_controls.on('keyup', '.customizer-repeater-social-repeater-link', function (event) {
        event.preventDefault();
        var repeater = jQuery(this).parent().parent();
        conceptly_customizer_repeater_refresh_social_icons(repeater);
        return false;
    ...
    conceptly_theme_controls.on('change', '.customizer-repeater-social-repeater-container .icp', function (event) {
        event.preventDefault();
...
function conceptlyescapeHtml(string) {
    'use strict';
    //noinspection JSUnresolvedFunction
    string = String(string).replace(new RegExp('\r?\n', 'g'), '<br />');
    string = String(string).replace(/\\/g, '&#92;');
    return String(string).replace(/[&<>"'\/]/g, function (s) {
        return conceptlyentityMap[s];
    });
