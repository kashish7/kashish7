 ...
 */
function conceptly_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function conceptly_sanitize_css( $css ) {
 ...
 */
function conceptly_sanitize_email( $email, $setting ) {
 ...
 */
function conceptly_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function conceptly_sanitize_html( $html ) {
 ...
 */
function conceptly_sanitize_image( $image, $setting ) {
 ...
 */
function conceptly_sanitize_nohtml( $nohtml ) {
 ...
 */
function conceptly_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function conceptly_sanitize_number_range( $number, $setting ) {
 ...
 */
function conceptly_sanitize_select( $input, $setting ) {
 ...
 */
function conceptly_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function conceptly_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function conceptly_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}

function conceptly_sanitize_select_icon( $input, $setting ) {
	
	// Ensure input is a slug.
	$choice = conceptly_get_icons();
	
	return ( array_key_exists( $input, $choice ) ? $input : '' );
}