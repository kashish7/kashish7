...
function freddo_scripts() {
	...
	if ( is_active_sidebar( 'sidebar-push' ) ) {
		wp_enqueue_script( 'freddo-nanoScroll', get_template_directory_uri() . '/js/jquery.nanoscroller.min.js', array('jquery'), '0.8.7', true );
	}
...
*/
function freddo_skip_link_focus_fix() {
...
add_action( 'wp_print_footer_scripts', 'freddo_skip_link_focus_fix' );
